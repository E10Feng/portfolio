  ...
  return (
    <section id="hero" className="min-h-screen bg-zinc-950 flex items-center justify-center px-6 pt-16 overflow-hidden">
      <div className="max-w-6xl w-full">
        ...
        {/* ── Split Portrait ─────────────────────────────── */}
        <FadeInWhenVisible>
          <div className="relative mx-auto mb-12" style={{ width: "340px", height: "420px" }}>
            {/* === LEFT HALF — painterly designer === */}
            <div
            ...
            >
              <img
                src={PORTRAIT_SRC}
                alt="Portrait — coder side"
                className="w-full h-full object-cover grayscale contrast-110"
              />
              {/* Dark vignette on the coder side for code snippet readability */}
              <div
        ...
        <FadeInWhenVisible delay={0.1}>
          <div className="grid grid-cols-2 gap-4 mb-12">
            ...
            <div className="text-right pr-2">
              ...
              <p className="mt-3 text-sm text-zinc-500 leading-relaxed max-w-xs ml-auto">

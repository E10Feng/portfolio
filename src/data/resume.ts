...
export const resumeItems: ResumeItem[] = [
  {
    ...
    description: [
      ...
      "rapidly prototyped ai features into production workflow software — including agentic vectorless rag, ocr, automated extraction, and audio transcription — reducing client workflow times by 85%",
    ],
  ...
  {
    id: "washu-biomedical-informatics",
    type: ["research", "internship"],
    organization: "washington university in st. louis, institute for biomedical informatics",
    role: "medical imaging ai undergraduate research intern",
    startDate: "aug 2024",
    endDate: "jan 2025",
    ...
    technologies: ["python", "pytorch", "sam2", "computer vision", "medical imaging"],
  },
  {
  ...
  },
  {
    ...
    description: [
      ...
      "d3 varsity swimming (7x ncaa all-american, ncaa finalist, cscaa individual scholar all-american)",
